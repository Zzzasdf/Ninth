...
namespace Ninth.Editor.Excel.Search
{
    ...
    public class SearchSettingsData
    {
        ...
        {
            get => WindowSOCore.Get<WindowExcelSearchConfig>().CompileDirectoryRoot;
            set => WindowSOCore.Get<WindowExcelSearchConfig>().CompileDirectoryRoot = value;
        }
        ...
        {
            get => WindowSOCore.Get<WindowExcelSearchConfig>().SearchMode;
            set => WindowSOCore.Get<WindowExcelSearchConfig>().SearchMode = value;
        }
        ...
        { 
            get => WindowSOCore.Get<WindowExcelSearchConfig>().SearchCompairsonType;
            set => WindowSOCore.Get<WindowExcelSearchConfig>().SearchCompairsonType = value;
        }
        public SearchDataMode SearchDataMode
        {
            get => WindowSOCore.Get<WindowExcelSearchConfig>().SearchDataMode;
            set => WindowSOCore.Get<WindowExcelSearchConfig>().SearchDataMode = value;
        }
        ...
        {
            get => WindowSOCore.Get<WindowExcelSearchConfig>().SearchDataGroupItems;
            set => WindowSOCore.Get<WindowExcelSearchConfig>().SearchDataGroupItems = value;
        }

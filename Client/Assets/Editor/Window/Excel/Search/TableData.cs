...
namespace Ninth.Editor.Excel.Search
{
    ...
    public class TableCollect
    {
        ...
        public TableCollect AddTable(FileInfo fileInfo)
        {
            try
            {
        ...
        public TableCollect AddCell(Cell cell)
        {
        ...
        public class Table
        {
            public TableCollect CompileResult { get; private set; }
            public string FullName { get; private set; }
            public string Name { get; private set; }
            public Dictionary<int, Sheet> Sheets { get; private set; }
            
            public Table(TableCollect compileResult, string fullName, string name)
            {

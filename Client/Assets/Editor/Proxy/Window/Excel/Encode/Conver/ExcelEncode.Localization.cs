...
//     {
//         private readonly string LocalizationExcelName = "Localization";

//         private void LocalizationDisplay(EncodeCompileTable table)
//         {
//             EditorGUILayout.LabelField(LocalizationExcelName);

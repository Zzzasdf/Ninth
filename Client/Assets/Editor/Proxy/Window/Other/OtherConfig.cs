...
//             {
//                 ["Open"] = () => Application.OpenURL(WindowSOCore.Get<BuildSO>().BuildBundlesTargetFolderRoot),
//             },
//             ["OutputPlayer"] = new Dictionary<string, Action>()
//             {
//                 ["Open"] = () => Application.OpenURL(WindowSOCore.Get<BuildSO>().BuildPlayersDirectoryRoot),
//             },
...
//         {
//             get => WindowSOCore.Get<OtherSO>().AppFoldout;
//             set => WindowSOCore.Get<OtherSO>().AppFoldout = value;
//         }
//
//         public bool BrowserFoldout
//         {
//             get => WindowSOCore.Get<OtherSO>().BrowserFoldout;
//             set => WindowSOCore.Get<OtherSO>().BrowserFoldout = value;
//         }
//
//         public bool DirectoryFoldout
//         {
//             get => WindowSOCore.Get<OtherSO>().DirectoryFoldout;
//             set => WindowSOCore.Get<OtherSO>().DirectoryFoldout = value;
//         }
//     }
// }

        ...
        public partial class ProcedureCore
        {
            public class LoadDll : IProcedure
            {
                ...
                public async Task<ProcedureInfo> Execute()
                {
...
#else
                    AssetMode assetMode = assetConfig.AssetMode;
                    if (assetConfig.ScriptMode.HasFlag(assetMode))
                    {
                    ...
                    else if (assetConfig.DllMode.HasFlag(assetMode))
                    {
                        return await LoadDllFromBytes();
                    }
                    else
                ...
                private async Task<ProcedureInfo> LoadDllFromBytes()
                {
                    ...
                    {
                        string dir = assetConfig.AssetMode switch
                        {
                ...
                public async Task<ProcedureInfo> ExitProcedure()
                {
                    if (m_GameAss == null)
                    {
